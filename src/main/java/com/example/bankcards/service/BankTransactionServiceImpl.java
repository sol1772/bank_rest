...
public class BankTransactionServiceImpl implements BankTransactionService {
    ...
    @PreAuthorize("hasAuthority('ADMIN')")
    public Page<BankTransactionDto> getAllBySenderCardId(Long cardId, Pageable pageable) {
        return bankTransactionRepository.findByFromCardId(cardId, pageable).map(mapper::toDto);
    }

    @PreAuthorize("hasAuthority('ADMIN')")
    public Page<BankTransactionDto> getAllByReceiverCardId(Long cardId, Pageable pageable) {
    ...
    @Transactional
    public void transferFunds(BankTransaction transaction, Long fromCardId, Long toCardId, BigDecimal amount) {
        try {
